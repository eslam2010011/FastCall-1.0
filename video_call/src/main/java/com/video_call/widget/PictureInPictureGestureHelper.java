...
import com.video_call.View.TouchInterceptingFrameLayout;
...
public class PictureInPictureGestureHelper extends GestureDetector.SimpleOnGestureListener {
  ...
  public static PictureInPictureGestureHelper applyTo(@NonNull View child) {
    com.video_call.View.TouchInterceptingFrameLayout parent          = (com.video_call.View.TouchInterceptingFrameLayout) child.getParent();
    final PictureInPictureGestureHelper helper          = new PictureInPictureGestureHelper(parent, child);
    final GestureDetectorCompat         gestureDetector = new GestureDetectorCompat(child.getContext(), helper);

    parent.setOnInterceptTouchEventListener(new TouchInterceptingFrameLayout.OnInterceptTouchEventListener() {
      @Override
  ...
  private void fling() {
    ...
    child.animate()
         ...
         .setDuration(250)
         .setInterpolator(new ViscousFluidInterpolator()).setListener(new Animator.AnimatorListener() {
      @Override
